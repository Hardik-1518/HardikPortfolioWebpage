...
const Projects = ({ theme, onPlaySnake }) => {
  ...
  const projectList = [
    ...
    },
    {
      ...
      image: project2,
      desc: 'An immersive 3D racing simulator designed and developed in Unity. Features realistic physics-based vehicle dynamics, obstacle avoidance, and responsive driving controls optimized for desktop.',
      tags: ['Unity', 'C# Scripting', '3D Graphics', 'Game Design'],
      category: 'game',
      primaryLink: 'https://github.com/Hardik-1518',
      primaryLabel: 'Game Demo',
      secondaryLink: null,
      secondaryLabel: null,
      playable: false,
    },
